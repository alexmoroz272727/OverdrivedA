...
public class DescText : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            if (GameObject.Find("Content").GetComponent<SnapScrolling>().isScrolling == false)
        {
            ...
            {
                GameObject.Find("Description").GetComponent<Text>().text = "Начальный множитель 15   Цены уменьшены в 4 раза";
            }
            if (GameObject.Find("Content").GetComponent<SnapScrolling>().selectedPanID == 9)
            {
                GameObject.Find("Description").GetComponent<Text>().text = "Начальный множитель 20   Цены уменьшены 4 раза    Игнорирует стены";
            }
